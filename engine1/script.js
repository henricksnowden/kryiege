...
//***********************************************
jQuery.extend(jQuery.easing, {easeOutBack2:function(f,g,e,j,i)
{
    var h=(g/=i)*g;
    var a=h*g;
...
function ws_tv(m,i,b)
{
    ...
    this.go=function(h,o) {
        if(k) {
            b.find(".ws_list").css("transform","translate3d(0,0,0)").stop(true).animate({left:(h?-h+"00%":(/Safari/.test(navigator.userAgent)?"0%":0))},m.duration,"easeInOutExpo",function() {
                g.trigger("effectEnd")
            })
        } else {
            j=b.width();
...
// http://javascript-source.com
//***********************************************
jQuery.extend(jQuery.easing, {easeOutBack:function(e,f,a,i,h,g)
{
    if(g==undefined) {
        g=1.70158
    }
...
function ws_dribbles(p,k,a)
{
    ...
    this.go=function(x,s) {
        if(n) {
            a.find(".ws_list").css("transform","translate3d(0,0,0)").stop(true).animate({left:(x?-x+"00%":(/Safari/.test(navigator.userAgent)?"0%":0))},p.duration,"easeInOutExpo",function() {
                j.trigger("effectEnd")
            })
        } else {
            m=a.width();
...
function ws_cube(p,k,b)
{
    ...
    var o= {domPrefixes:" Webkit Moz ms O Khtml".split(" "),testDom:function(r){var q=this.domPrefixes.length; while(q--)
        {
            if(typeof document.body.style[this.domPrefixes[q]+r]!=="undefined") {
                return true
            }
        } return false
    },cssTransitions:function(){return this.testDom("Transition")},cssTransforms3d:function(){var r=(typeof document.body.style.perspectiveProperty!=="undefined")||this.testDom("Perspective"); if(r&&/AppleWebKit/.test(navigator.userAgent))
        {
...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"tv,lines,dribbles,cube,book,rotate,domino,blinds",prev:"",next:"",duration:20*100,delay:20*100,width:640,height:480,autoPlay:true,autoPlayVideo:false,playPause:true,stopOnHover:false,loop:false,bullets:1,caption:true,captionEffect:"parallax",controls:true,controlsThumb:["data1/tooltips/brighton_high_school.jpg", "data1/tooltips/brighton_high_school_center_for_the_performing_arts.jpg", "data1/tooltips/everett_high_school_lansing,_michigan_2.jpg", "data1/tooltips/hyundaisouthafrica.jpg", "data1/tooltips/img_1617.jpg", "data1/tooltips/mcclung+ms+hales129597+widescreen.jpg", "data1/tooltips/slideshow1.jpg", "data1/tooltips/slideshow3.jpg"],responsive:1,fullScreen:false,gestures:2,onBeforeStep:0,images:0});
